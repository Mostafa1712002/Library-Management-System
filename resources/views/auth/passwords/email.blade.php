                            ...
                            <div class="card border-grey border-lighten-3 px-2 py-2 m-0">
                                <div class="card-header border-0 pb-0">
                                    ...
                                    <h6 class="card-subtitle line-on-side text-muted text-center font-small-3 pt-2">
                                        <span style="font-size:22px">سنرسل لك رابط لتقوم باعادة كلمة المرور</span>
                                    </h6>
                                </div>
                                    ...
                                    <div class="card-body">
                                        ...
                                        <form method="POST" class="form-horizontal" action="{{ route('password.email') }}">
                                            ...
                                            <fieldset class="form-group position-relative has-icon-left">
                                                <input id="email" type="email" class="form-control form-control-lg input-lg @error('email') is-invalid @enderror" name="email" value="{{ old('email') }}" required autocomplete="email" placeholder="البريد الالكتروني" autofocus>
                                            ...
                                            <button type="submit" class="btn btn-outline-info btn-lg btn-block"><i class="ft-unlock"></i>اعادة تعيين كلمة المرور</button>
                                ...
                                <div class="card-footer border-0">
                                    <p class="float-sm-left text-center"><a href="{{ route("login") }}" class="card-link">تسجيل الدخول</a></p>
                                </div>
                            </div>
                        </div>
                    </div>
