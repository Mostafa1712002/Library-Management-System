<div class="main-menu menu-fixed menu-dark menu-accordion menu-shadow" data-scroll-to-active="true">
    <div class="main-menu-content">
        ...
        <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
            ...
            <li class=" nav-item"><a href="index.html"><i class="la la-bullseye"></i><span class="menu-title" data-i18n="nav.dash.main">اراء العملاء</a>
                <ul class="menu-content">

                    <li><a class="menu-item" href="{{ route("testimonials.index") }}" data-i18n="nav.dash.ecommerce">عرض</a>
                    </li>
                    <li><a class="menu-item" href="dashboard-crypto.html" data-i18n="nav.dash.crypto">انشاء</a>
                    </li>
                </ul>
            </li>
